...
linguicao = sum(inters, [])

# percorremos lista de intervalos e coletamos as incidências para cada motivo
# intervalar de scarlatti
C = []
ci = 0
        ...
        for i in xrange(len(inters)):
            ...
            for j in xrange(len(inter)):
                ...
                if len(trecho) < len(inter_scar): # preciso de notas
                    ...
                    k = 1
                    falta = None
                    # procuro notas nos proximos k compassos, ateh me fartar
